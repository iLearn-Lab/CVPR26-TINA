...
def imagenet_ResNet50(device):
    ...
    # processor = AutoImageProcessor.from_pretrained("path/to/resnet-50", cache_dir=".cache")
    # model = ResNetForImageClassification.from_pretrained("path/to/resnet-50", cache_dir=".cache")
    model.to(device)
